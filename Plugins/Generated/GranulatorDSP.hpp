 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			int iTemp27 = int(0.5f * fTemp19 * (1.0f - float(iRec14)));
			...
			int iTemp31 = int(0.5f * fTemp19 * (1.0f - float(iRec12)));
			...
			int iTemp35 = int(0.5f * fTemp19 * (1.0f - float(iRec10)));
			...
			int iTemp39 = int(0.5f * fTemp19 * (1.0f - float(iRec8)));
			...
			int iTemp43 = int(0.5f * fTemp19 * (1.0f - float(iRec6)));
			...
			int iTemp47 = int(0.5f * fTemp19 * (1.0f - float(iRec4)));
			...
			int iTemp51 = int(0.5f * fTemp19 * (1.0f - float(iRec2[0])));
			...
			int iTemp56 = int(0.5f * fTemp19 * (1.0f - float(iRec17)));
			...
			int iTemp61 = int(0.5f * fTemp19 * (1.0f - float(iRec15)));
			...
			int iTemp65 = int(0.5f * fTemp19 * (1.0f - float(iRec13)));
			...
			int iTemp69 = int(0.5f * fTemp19 * (1.0f - float(iRec11)));
			...
			int iTemp73 = int(0.5f * fTemp19 * (1.0f - float(iRec9)));
			...
			int iTemp77 = int(0.5f * fTemp19 * (1.0f - float(iRec7)));
			...
			int iTemp81 = int(0.5f * fTemp19 * (1.0f - float(iRec5)));
			...
			int iTemp85 = int(0.5f * fTemp19 * (1.0f - float(iRec3)));
